...
int16_t temp_celsius = 0; // Temperatura en �C (opcional)
...
void main(void) {
    ...
    while (1) {
            ...
            // Esperar el tiempo necesario para la conversi�n (750 ms para 12 bits)
            ...
            // Convertir valor a grados Celsius
...
//------------------------------------------------------------------------------
// Implementaci�n de Single_reset()
//------------------------------------------------------------------------------
void Single_reset(void) {
...
//------------------------------------------------------------------------------
// Implementaci�n de Single_write()
//------------------------------------------------------------------------------
void Single_write(uint8_t data) {
    uint8_t ibit;
...
uint8_t Single_read(void) {
    ...
    for(ibit=0; ibit < 8; ibit++) {
        P1OUT &= ~BIT5;      // Llevar l�nea a bajo
        ...
        P1OUT |= BIT5;       // Llevar l�nea a alto
        P1DIR |= BIT5;       // P1.5 como salida
    }
    return data;
}
